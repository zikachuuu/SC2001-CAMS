...
public class CAMSApp {
    ...
    public static void main(String[] args) {
        ...
        // Read  from the files
        ArrayList<Student> students = StudentClass.readStudentsFromFile(studentFilePath);
        ArrayList<Staff> staffMembers = StaffClass.readStaffFromFile(staffFilePath);
        ArrayList<Camp> camps = CampClass.readCampsFromFile(CAMPS_FILE_PATH);
        ArrayList<Enquiry> enquiries = EnquiriesClass.readEnquiriesFromFile(ENQUIRIES_FILE_PATH);
        // ArrayList<CampRegistration> studentRegistrations = CampRegistration.readRegistrationsFromFile(CAMP_MEMBERS_FILE_PATH);
        ArrayList<Suggestion> suggestions = SuggestionsClass.readSuggestionsFromFile(SUGGESTIONS_FILE_PATH);
    ...
    private static Student authenticateStudent(String userId, String password, ArrayList<Student> students) {
    ...
    private static Staff authenticateStaff(String userId, String password, ArrayList<Staff> staffMembers) {
